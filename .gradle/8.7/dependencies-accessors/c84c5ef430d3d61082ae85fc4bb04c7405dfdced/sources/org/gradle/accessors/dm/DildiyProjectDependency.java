...
@NonNullApi
public class DildiyProjectDependency extends DelegatingProjectDependency {

    @Inject
    public DildiyProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
